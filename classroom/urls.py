...
urlpatterns = [
    ...
    path("api/sessions/<uuid:pk>/<int:student_id>/toggle/", views.toggle_attendance_api,  name="toggle_attendance"),
    path("checkin/<uuid:pk>/", views.session_checkin_view, name="session_checkin"),
